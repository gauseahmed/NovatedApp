@Regression
Feature: 04 SMB Regression feature
  ...
  Scenario: TC001_Verify Introducer is able to Request a quote and Submit the application for New Asset and Dealer Pricing with Chattel Mortgage for Passenger or LCV Entity Type:  Sole Trader
    Given I setup environment and login with role "introducer"
    Given I load test data for "TC001" from "04_SMB_Regression"
    ...
    Then I click on element with text from excel "excel:Do you have a specific medical, office or other business equipment in mind?"
    ...
    Then I populate field "Asset Category[2]" with excel "excel:Vehicle or Asset Category"
...
#   Summary tab Inputs and data verification
  ...
  Scenario: TC002_Verify creditManager is able to validate the credit rules and manually overwrite credit decision
    ...
    Given I load test data for "TC002" from "04_SMB_Regression"
...
#    Verifying content on 'Quote Details'
  ...
  Scenario: TC003_Verify Introducer is able to Request a quote and Submit the application for New Asset and Dealer Pricing with Chattel Mortgage for Passenger or LCV Entity Type:  Sole Trader
    Given I setup environment and login with role "introducer"
    Given I load test data for "TC003" from "04_SMB_Regression"
    Then I click on button "Request A Quote"
    Then I populate field "Search Journeys" with excel "excel:ABN"
    Then I click on button "SEARCH[2]"
    Then I select grid "[2]" row "[1]"
...
#   Summary tab Inputs and data verification
  ...
  Scenario: TC004_Verify creditManager is able to validate the credit rules and manually overwrite credit decision
    Given I setup environment and login with role "creditManager"
    Given I load test data for "TC004" from "04_SMB_Regression"
    When I click on record from excel "excel:Application Number"
    #  Business tab Inputs and data verification
    Then I verify field "ABN" contains excel "excel:ABN"
    Then I verify field "Registered Business Name" contains excel "excel:Registered Business Name"
