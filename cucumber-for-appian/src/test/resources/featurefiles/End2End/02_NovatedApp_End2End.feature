...
Feature: 02 NovatedApp End2End feature
  ...
  Scenario: TC001_Verify driver can submit and verify request of reimbursement claim with correct information per claim type.  Claim Type - Service
    ...
    Then I verify text "VOLVO XC40 - FTJ63Y" is present
    ...
    Then I verify field "Submitted By" contains "David Cracknell"
  ...
  Scenario: TC002_Verify Novated lease specialist can view and take decision on submitted claim
    ...
    Then I verify field "Last Name" contains "Cracknell"
    Then I verify field "Primary Email" contains "david.cracknell@keyton.com.au.test"
    Then I verify field "Mobile" contains "0409999999"
