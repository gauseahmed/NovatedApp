...
Feature: 04 NovatedApp End2End feature
  ...
  Scenario: TC001_Verify driver can raise request to Add New Fuel Card
    Given I setup environment and login with role "Driverpeter"
    ...
    Then I verify text "15 Kartner Rd, Tapping WA 6065" is present
    ...
    Then I wait for "2" seconds
    Then I verify text "NISSAN X-TRAIL - S651CZJ" is present
  ...
  Scenario: TC002_Verify Novated lease specialist can view and complete decision on submitted Add New Fuel Card
    ...
    Then I verify field "End Of Lease Date" contains "21/03/2027"
    Then I verify field "Submitted By" contains "Peter Millard"
    Then I verify field "Submitted On" contains excel "excel:Reading Date"
    Then I verify field "Updated By" contains "Peter Millard"
