...
Feature: 07 NovatedApp End2End feature
  ...
  Scenario: TC001_Collecting Driver details to validate in future task
    Given I setup environment and login with role "Driverdarryn"
  ...
  Scenario: TC002_Verify driver can request payout
    ...
    Then I wait for "3" seconds
#    Then I get field "Payout Amount" value and store in excel "excel:Payout Amount"
#    Then I get field "Payout Valid-to Date" value and store in excel "excel:Payout Valid-to Date"
    ...
    Then I wait for "1" seconds
    Then I populate field "Upload[1]" with excel "excel:Remittance Advice"
    ...
    Then I verify field "Odometer Reading" contains excel "excel:Payout Odometer"
  ...
  Scenario: TC003_Verify Novated Lease  Specialist can view and action payout requests
    ...
    Then I get field "Lease Type" value and store in excel "excel:Lease Type"
    Then I verify field "Submitted By" contains excel "excel:Driver Name"
...
#    Then I verify field "Registration Number" contains "CPK418"
    Then I verify field "Registration State" contains "SA"
...
#    Then I verify grid "[1]" column "Type" row "[1]" contains "Remittance Advice"
    ...
    Then I click on checkbox option "Remittance Advice Uploaded by Driver"
    Then I click on checkbox option "Allocate funds to Driver Bill-To in OMS"
    Then I click on checkbox option "Driver Receipt Issued"
    Then I wait for "2" seconds
    Then I click on button "Submit"
    Then I wait for "2" seconds
    Then I verify field "Status" contains "Closed"
    Then I verify field "Termination Method" contains "Cash"
    Then I wait for "1" seconds

    #ET Washup Task Assigned
    Then I click on site page "Requests"
    Then I wait for "3" seconds
    Then I click on grid "[1]" column "[1]" row "[1]"
    Then I wait for "2" seconds
    Then I verify text "Request Details" is present
    #Then I verify field "Status" contains "New"
    Then I verify text "ET Wash-Up" is present
    Then I verify field "End Of Lease Date" contains excel "excel:EOL Date"
    Then I verify field "Lease Type" contains excel "excel:Lease Type"
    Then I verify field "Assigned To" contains "Unassigned"
    Then I verify text "Driver Details" is present
    Then I verify field "Salutation" contains excel "excel:Driver Salutation"
    Then I verify field "First Name" contains excel "excel:Driver First Name"
