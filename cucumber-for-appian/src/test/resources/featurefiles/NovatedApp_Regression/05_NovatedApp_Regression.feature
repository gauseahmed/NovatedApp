@Regression
Feature: 05 NovatedApp Regression feature
  ...
  Scenario: TC001_Fuel Card_Verify driver can raise request to Add New Fuel Card
    ...
    Then I populate field "Fuel Provider" with excel "excel:Fuel Provider"
  ...
  Scenario: TC002_Fuel Card_Verify Novated lease specialist can view and complete decision on submitted Add New Fuel Card
    Given I setup environment and login with role "AutoLease"
    Given I load test data for "TC002" from "05_NovatedApp_Regression"
  ...
  Scenario: TC004_Fuel Card_Verify Novated lease specialist can view and complete decision on submitted Replace Fuel Card Request
    Given I setup environment and login with role "AutoLease"
    Given I load test data for "TC004" from "05_NovatedApp_Regression"
    Then I click on site page "Requests"
    Then I populate field "Search Requests" with excel "excel:Reference Number"
    Then I click on button "Search"
    Then I wait for "3" seconds
